...
{
    // MENÚ PRINCIPAL
    ConsoleInterface.PosicionMenu = Menus.Inicio;
    ConsoleInterface.ConsoleImpresionMenus(ConsoleInterface.PosicionMenu);
    switch (ConsoleInterface.LeerInt(5)){

        case 1:
            ConsoleInterface.PosicionMenu = Menus.AdministracionCuentas;
            ConsoleInterface.ConsoleImpresionMenus(ConsoleInterface.PosicionMenu);
            switch (ConsoleInterface.LeerInt(4))
            {
                case 1:
        ...
        case 2:
            ...
            break;
        case 3:
            ConsoleInterface.PosicionMenu = Menus.Operaciones;
            ConsoleInterface.ConsoleImpresionMenus(ConsoleInterface.PosicionMenu);
            switch (ConsoleInterface.LeerInt(4))
            {
                case 1:
